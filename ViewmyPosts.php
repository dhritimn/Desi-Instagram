...
<div style="overflow: auto;"> 
        ...
        <a class="btn btn-primary" href="Settings.php"><i class="fa fa-gear"></i> Settings</a>
          ...
          <div style="width: fit-content; margin: 2px auto;">
            <img id="bgmi" style="height: 125px; border: 1px solid black; width: 127px; border-radius: 76px; margin: 9px auto;" src="OIP.jfif" alt="Desi INSTAGRAM"> 
          </div>
       ...
       <hr>
          ...
          <div>
            <div style="margin: 10px 15px;" class="viewmyposts">
              <h3 style="text-align: center; color: blue;">Here are your posts</h3>
            </div>
            <div style="display: flex; justify-content: center; flex-wrap: wrap;" class="postbox">
            <?php
            $User = $_SESSION['Username'];
            $sql7 = "SELECT * FROM `posts`  WHERE `Username` = '$User' ORDER BY `posts`.`Time` DESC;";
            $res7 = mysqli_query($conn,$sql7);
            $numRow7 = mysqli_num_rows($res7);
            if ($numRow7 == 0) {
                echo '<div style="display: flex; justify-content: center; padding: 2px 10px; color: #9d9d9d; align-items: center; height: 200px;"><h3>You have not posted anything yet.<h3></div>';
            }
            else {
            for ($k=1; $k <= $numRow7 ; $k++) { 
              ...
              <div style="display: flex; align-itmes: center; border-bottom: 2px solid black;" class="postNav">
                <ul style="overflow: auto; display: flex; align-items: center;">
                  <li style="list-style: none; padding: 0px 2px; margin: 0px 5px;"><img style="height: 45px; border: 1px solid black; width: 45px; border-radius: 80px; margin: 9px auto;" src="OIP.jfif" alt="di"></li>
              ...
              if ($enqq != 10) {
                ...
                <ul style="overflow: auto">
                  <li style="float: left; list-style: none; margin: 1px 0px;">
                  <form action="components/deleteMyPost.php" method="post">
                  <input type="text" name="sln" id="sln" value='.$data7['Sl no.'].' style="display: none;">
